...
const Footer = () => {
    return (
        <FootBrunch>
          <InnerFoot>
            <div className="wrap__info" style={{display:"flex", justifyContent:"space-between", marginBottom:"35px"}}>
            ...
            <WrapCorp>
              <small className="txt__copyright" style={txt__copyright}>
                <a href="#" className="link__corp" style={link__corp}>@ kakao</a>
              </small>
              <div>
                <ul className="list__download" style={{display:"flex"}}>
                  <li className="link__info">
                    <a href="#">
                      <span className="ico__brunch ico__android" style={ico__brunch}>안드로이드 앱 다운로드</span>
                    </a>
                  </li>
                  <li className="link__info" style={{marginLeft:"25px"}}>
                    <a href="#">
                      <span className="ico__brunch ico__ios" style={ico__ios}>아이폰 앱 다운로드</span>
                    </a>
                  </li>
                </ul>
              </div>
