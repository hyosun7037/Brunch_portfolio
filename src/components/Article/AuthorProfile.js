...
const AuthorProfile = ({ profileImageText }) => {
  return (
    <>
      <div
        className="wrap__author"
        style={{
          padding: "0 0 80px",
        ...
        >
          ...
          >
            <Link to="/profile">
              ...
              <p
                className="txt__desc"
                style={{ color: "#959595", fontWeight: "300", lineHeight: "2" }}
              >
                '달' 입니다. 때로는 삐딱한 시선으로, 때로는 달달한 시선으로
                누군가는 공감할 수 있는 삶을 이야기합니다. 책을 읽고 여행을
                다니며 떠오르는 단상을 글과 그림으로 옮기기도 합니다
              </p>
            </Link>
          </div>
          {/* 구독자 */}
          <div
            className="wrap__subs"
            style={{
              marginTop: "34px",
              display: "flex",
